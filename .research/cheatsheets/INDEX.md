...
- [Codex and Claude Instructions](agents/codex-claude-instructions-cheatsheet.md) — shared `.agents/AGENTS.md` sources, Codex fallback discovery, Claude adapters, home-directory guardrails
